          ...
          >
            <View style={{ flexDirection: "row", justifyContent: "space-between", gap: spacing.sm }}>
              <View style={{ flex: 1, gap: spacing.sm }}>
                <Text style={{ color: "rgba(219, 234, 254, 0.84)", fontSize: 12, fontWeight: "700", textTransform: "uppercase" }}>
                  Active Shift Card
                </Text>
                ...
                <Text style={{ color: "rgba(226, 232, 240, 0.84)", fontSize: 14, lineHeight: 21 }}>
                  {activeSession
                    ...
                    : "Defina o odometro inicial e inicie o turno com uma experiencia mais rapida e confiavel."}
                </Text>
              </View>
              <View
                style={{
              ...
              >
                <Ionicons name="car-sport" size={54} color={appColors.white} />
              </View>
            </View>
